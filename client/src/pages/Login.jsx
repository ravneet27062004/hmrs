        ...
        <div className="min-h-screen flex items-center justify-center bg-[#0B1120] px-4">
            ...
            <>
                ...
                <form
                    ...
                    className="w-full sm:w-[350px] text-center bg-white/6 backdrop-blur-lg border border-white/10 rounded-2xl px-8"
                >
                    ...
                    <button
                        type="submit"
                        className="mt-6 w-full h-11 rounded-full text-white bg-indigo-600 hover:bg-indigo-500 transition mb-8"
                    >
                        {state === "login"
                            ? "Login"
                            : "Sign up"}
  ...
  <span className="text-indigo-400 ml-1">
    Click here
                ...
                <div className="fixed inset-0 -z-10 pointer-events-none">
                    ...
                    <div className="absolute left-1/2 top-20 -translate-x-1/2 w-[500px] h-[250px] bg-gradient-to-tr from-indigo-800/35 to-transparent rounded-full blur-3xl" />

                    <div className="absolute right-12 bottom-10 w-[250px] h-[150px] bg-gradient-to-bl from-indigo-700/35 to-transparent rounded-full blur-2xl" />
